 ...
 * <ul>
 *   <li>{prefix}/weight — numeric weight value as a string</li>
 *   <li>{prefix}/unit   — unit reported by the scale (e.g. "kg")</li>
 *   <li>{prefix}/status — "online" while running; LWT publishes "offline"</li>
 * </ul>
 */
